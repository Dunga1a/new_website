...
const jwt_authentication_guard_1 = require("./utils/jwt/jwt-authentication.guard");
const LocalGuards_1 = require("./utils/local/LocalGuards");
const roles_decorator_1 = require("./utils/role/roles.decorator");
...
__decorate([
    (0, common_1.UseGuards)(LocalGuards_1.LocalAuthGuard),
...
__decorate([
    (0, roles_decorator_1.Roles)(types_1.default.Admin),
    (0, common_1.UseGuards)(jwt_authentication_guard_1.default, roles_guard_1.RolesGuard),
