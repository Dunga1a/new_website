...
export class NewsCategoryController {
  ...
  async createNewsCategory(@Body() newsCategory: CreateNewsCategoryDto) {
    const savedNewsCategory = await this.newsCategoryService.createNewsCategory(
      newsCategory,
    );
  ...
  async getAllNewsCategory(@Query() queryParams: any) {
    const newsCategory = await this.newsCategoryService.getAllNewsCategory(
      queryParams,
    );
  ...
  async getOneCategory(@Param('id', ParseIntPipe) idNewsCategory: number) {
    const result = await this.newsCategoryService.getOneCategory(
      idNewsCategory,
    );
    return result;
  }
  ...
  async getOneCategoryById(@Param('id', ParseIntPipe) idNewsCategory: number) {
    const result = await this.newsCategoryService.getOneCategoryById(
      idNewsCategory,
    );
    return result;
  }
  ...
  async deleteManyNewsCategory(@Body() deletedManyCategory: number[]) {
    const result = await this.newsCategoryService.deleteManyNewsCategory(
      deletedManyCategory,
    );
    return result;
  }
