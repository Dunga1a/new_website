            ...
            <div className="border-[1px] border-solid border-[#4f4f4f] px-6 py-4 rounded">
              ...
              <div className="leading-[1.7em] mb-3">
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      Hội Doanh nhân Thanh Hóa tại Hà Nội tự nguyện thành lập
                      hoạt động trên nguyên tắc của điều lệ này, nhằm mục đích
                      tập hợp, đoàn kết hội viên có mong muốn tham gia hoạt động
                      hội
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      1. Kết nối các doanh nhân xứ Thanh tại Hà Nội nhằm mục
                      đích giao lưu, chia sẻ kinh nghiệm, và hợp tác phát triển
                      trong công việc
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      2. Là cầu nối với quê hương để các doanh nhân Thanh Hóa
                      tại Hà Nội có thể đóng góp ý tưởng, trực tiếp hoặc kêu gọi
                      các Doanh nhân, doanh nghiệp đầu tư nhằm phát triển quê
                      hương
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      3. Cùng chung tay với Hội đồng hương Thanh Hóa tại Hà Nội
                      để gánh vác nhiều trách nhiệm của đồng hương
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      Thanh đang học tập tại Hà Nội, hỗ trợ các trường hợp có
                      hoàn cảnh khó khăn.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Thường xuyên cung cấp cho thành viên của hội các thông
                      tin liên quan đến hoạt động của hội ;
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Tổ chức các hội nghị, hội thảo để trao đổi kinh nghiệm
                      đầu tư, quản lý, khai thác, kinh doanh, kết nối kinh
                      doanh;
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      tác cùng có lợi, giải quyết bất đồng thông qua thương
                      lượng và tôn trọng phán quyết của Ban thường vụ; thỏa
                      thuận song phương giữa các thành viên không vi phạm nguyên
                      tắc của hội, không tổn hại đến lợi ích chung.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      phòng Hội và các ban chuyên môn: Ban kiểm tra; Ban hội
                      viên; Ban tài chính; Ban xúc tiến đầu tư; Ban truyền
                      thông. Các câu lạc bộ trực thuộc hội: Câu lạc bộ golf
                      doanh nhân Thanh Hoá tại Hà Nội; Câu lạc bộ nữ DNTH tại Hà
                      Nội và các Hội doanh nhân đồng hương các huyện tự nguyện
                      đăng ký gia nhập Hội Doanh nhân Thanh Hoá tại Hà Nội.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      thường được triệu tập khi có ít nhất 2/3 (hai phần ba)
                      tổng số ủy viên Ban Chấp hành có đề nghị bằng văn bản.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      lượng, thành phần đại biểu do Ban Chấp hành quyết định.
                      Đại hộitoàn thể hoặc Đại hội đại biểu được coi là hợp lệ
                      khi có trên 1/2 (một phần hai) số hội viên chính thức hoặc
                      có trên 1/2 (một phần hai) số đại biểu chính thức được
                      triệu tập có mặt.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      chính thức của Hội. Số lượng, cơ cấu, tiêu chuẩn ủy viên
                      Ban Chấp hành được quy định tại điều lệ này. Số lượng uỷ
                      viên BCH không quá 25 người. Trong quá trình hoạt động nếu
                      cần thiết có thể bổ sung thêm và có thể thay thế những uỷ
                      viên ban chấp hành không đáp ứng yêu cầu và tiêu chuẩn
                      hoạt động.
                    </span>
                  </span>
                </p>
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      lệ Hội, lãnh đạo mọi hoạt động của Hội giữa hai kỳ Đại
                      hội;
                    </span>
                  </span>
                </p>
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      chế hoạt động của Ban Chấp hành, Ban Thường vụ; quy chế
                      quản lý, sử dụng tài chính của Hội;
                    </span>
                  </span>
                </p>
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      viên Ban Chấp hành bầu bổ sung không được quá 1/3 (một
                      phần ba) số lượng ủy viên Ban Chấp hành đã được Đại hội
                      quyết định.
                    </span>
                  </span>
                </p>
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      c) Các cuộc họp Ban Chấp hành là hợp lệ khi có ít nhất
                      trên 1/2 (một phần hai) số ủy viên Ban Chấp hành tham gia
                      dự họp. Ban Chấp hành có thể biểu quyết bằng hình thức giơ
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      Ủy viên Ban chấp hành Hội phải là người có đầy đủ các yếu
                      tố sau:
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Tôn trọng và thực hiện nghiêm túc các nghị quyết của
                      BCH, BTV, lãnh đạo hội.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Hội phí tối thiểu 10.000.000 đồng/ năm hỗ trợ hoạt động
                      tự giác, đầy đủ, đúng hạn và thiện tâm;
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Phản hồi đầy đủ các thông tin của Ban thường trực khi
                      nhận được qua các kênh quản lý Hội như Điện thoại, Mail,
                      Group (Zalo, Viber, Facebook…)
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      người gồm: Chủ tịch, các Phó Chủ tịch các trưởng ban
                      chuyên môn và các ủy viên. Nhiệm kỳ của Ban Thường vụ cùng
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      b) Ban Thường vụ họp mỗi quý lần, có thể họp bất thường
                      khi có yêu cầu của Chủ tịch Hội hoặc trên 2/3 (hai phần
                      ba) số ủy viên Ban Thường vụ có ý kiến;
                    </span>
                  </span>
                </p>
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      2/3 (hai phần ba) số ủy viên Ban Thường vụ tham gia dự
                      họp. Ban Thường vụ có thể biểu quyết bằng hình thức giơ
                      tay hoặc bỏ phiếu kín. Việc quy định hình thức biểu quyết
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      Ủy viên Ban thường vụ Hội phải là người có đầy đủ các yếu
                      tố sau:
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      tập hợp, quy tụ được hội viên, có uy tín, sức khỏe, có
                      thời gian, tâm huyết;
                    </span>
                  </span>
                </p>
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      b) Chịu trách nhiệm trước Ban Chấp hành, Ban Thường vụ
                      Hội; chỉ đạo, điều hành mọi hoạt động của Hội theo quy
                      định của Điều lệ Hội, nghị quyết, quyết định của Ban Chấp
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      d) Thay mặt Ban Chấp hành, Ban Thường vụ ký các văn bản
                      của Hội;
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      của Hội theo sự phân công của Chủ tịch Hội; chịu trách
                      nhiệm trước Chủ tịch Hội về công việc được Chủ tịch phân
                      công hoặc ủy quyền. Phó Chủ tịch Hội thực hiện nhiệm vu,
                      quyền hạn theo điều lệ hội.
                    </span>
                  </span>
                </p>
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      a) Tổng thư ký Hội là người giúp việc cho Chủ tịch Hội,
                      Các Phó Chủ tịch, BTV và BCH Hội. điều hành công việc hàng
                      ngày của Hội theo nghị quyết, chương trình, kế hoạch công
                      tác và theo điều lệ của Hội đã được Đại hội, Ban Chấp
                ...
                <p className="ml-3">
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      b) Tổng thư ký do Ban Chấp hành Hội bầu, miễn nhiệm làm
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Xây dựng quy chế hoạt động của Văn phòng Hội, quy chế
                      quản lý tài chính của Hội trình Ban Thường vụ thông qua và
                      báo cáo Ban Chấp hành Hội;
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Định kỳ báo cáo Ban Chấp hành, Ban Thường vụ Hội các
                      hoạt động của Hội theo quy định của Điều lệ Hội;
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Thư ký các kỳ Đại hội, các cuộc họp của Ban Chấp hành,
                      Ban Thường vụ Hội;
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Chịu trách nhiệm trước Ban Chấp hành, Ban Thường vụ Hội
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      Ban Thường vụ Hội ban hành theo Điều lệ Hội phù hợp với
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      2. Căn cứ vào điều lệ hoạt động và tiêu chuẩn thành viên
                      của hội, Ban hội viên phối hợp với văn phòng hội đề xuất
                      với Ban thường vụ ra quyết định công nhận thành viên chính
                      thức.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      định tại Điều 14 và thực hiện các nghĩa vụ theo quy định
                      tại Điều 14.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      viên của hội, và được thực hiện nghi thức kết nạp thành
                      viên mới.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      3. Được tham gia các hoạt động của hội, các hoạt động do
                      Ban thường vụ tổ chức.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      5. Được hỗ trợ kết nối với hội viên và các lãnh đạo tỉnh
                      về công tác đầu tư.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      7. Được hội thăm hỏi khi ốm đau, gia đình có tứ thân phụ
                      mẫu qua đời, chúc mừng sinh nhật và được.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      ...
                      đoàn kết, giúp đỡ các thành viên phát huy mọi khả năng,
                      tiềm lực để phát triển và nâng cao hiệu quả hoạt động.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      1. Ban chấp hành quy định việc quản lý sử dụng tài chính
                      của hội phù hợp với quy định của nhà nước.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      Hội sử dụng kinh phí của mình để chi cho những việc sau
                      đây:
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Trang trải các chi phí cho hoạt động của hội theo quy
                      định của điều lệ hoạt động của hội như hoạt động thông
                      tin, hội nghị, hội thảo, tuyên truyền, báo chí, thuê văn
                      phòng, nhân sự văn phòng hội…
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      - Các khoản chi phí cần thiết, hợp lý khác do Ban chấp
                      hành quyết định trên cơ sở đề xuất của Ban thường vụ theo
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      Những thành viên của hội, thành viên Ban chấp hành có
                      nhiều thành tích đóng góp cho hoạt động của hội, có tinh
                      thần trách nhiệm, tích cực hỗ trợ, giúp đỡ các thành viên
                      khác trong hội, được Ban chấp hành bộ khen thưởng bằng các
                      hình thức về vật chất và tinh thần. đề nghị UBND tỉnh khen
                      thưởng.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      Các thành viên của hội vi phạm đạo đức, hoạt động trái
                      pháp luật, vi phạm các quy định về nội dung thông tin đưa
                      vào, lưu trữ, truyền đi trên trang Web của hội và vi phạm
                      các quy định của điều lệ này thì tuỳ theo tính chất, mức
                      độ vi phạm sẽ bị đình chỉ quyền truy cập cung cấp thông
                      tin và xem xét tư cách thành viên của hội.
                    </span>
                  </span>
                </p>
                ...
                <p>
                  <span className="text-[16px] font-normal ">
                    <span className=" font-regu">
                      <strong>Điều 20.</strong>Điều lệ này có hiệu lực kể từ
                      ngày ký, việc điều chỉnh, bổ sung điều lệ do Đại hội quyết
                      định./.
                    </span>
                  </span>
                </p>
